...
{% hint style="success" %}
You'll get a notification when the build completes — by email, Slack, or whatever you configured under [automations.md](../hardware/automations.md "mention").
{% endhint %}
...
{% content-ref url="../hardware/custom-domains.md" %}
[custom-domains.md](../hardware/custom-domains.md)
{% endcontent-ref %}

{% content-ref url="../hardware/automations.md" %}
[automations.md](../hardware/automations.md)
{% endcontent-ref %}

{% content-ref url="../software/permissions.md" %}
[permissions.md](../software/permissions.md)
{% endcontent-ref %}
